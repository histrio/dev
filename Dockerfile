...
RUN wget "https://www.dropbox.com/s/15rjnc0l7y0c487/.gitconfig?dl=1" -O ~/.gitconfig && \
    wget "https://www.dropbox.com/s/utyh1m9q6hlqunu/.gitignore?dl=1" -O ~/.gitignore && \
...
RUN wget "https://www.dropbox.com/s/c1rl3w5kna7qnmb/.vimrc?dl=1" -O ~/.vimrc && \
    wget "https://www.dropbox.com/s/drep9vgdgfykq1w/.wakatime.cfg?dl=1" -O ~/.wakatime.cfg && \
    git clone "https://github.com/VundleVim/Vundle.vim.git" ~/.vim/bundle/Vundle.vim && \
    vim +PluginInstall +qall chdir=/tmp > /dev/null

RUN wget "https://www.dropbox.com/s/xwy9cs2vca0jrnu/.tmux.conf?dl=1" -O /root/.tmux.conf
